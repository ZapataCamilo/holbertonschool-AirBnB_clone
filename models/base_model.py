...
class BaseModel():
    ...
    def __init__(self, *args):
        ...
        self.created_at = datetime.datetime(year=2023, month=02, day=27, hour=16, minute=26, tzinfo=None)
        self.updated_at = datetime.datetime(year=2023, month=02, day=27, hour=16, minute=26, tzinfo=None)
